    ...
    <div class="card-body">
        <form method="POST" action="{{ route('vendorStore') }}">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="tin_number" id="tin_number" class="form-control @error('tin_number') is-invalid @enderror" value="{{ old('tin_number') }}">
                @error('tin_number')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="bank_details" id="bank_details" class="form-control @error('bank_details') is-invalid @enderror" rows="3">{{ old('bank_details') }}</textarea>
                @error('bank_details')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
